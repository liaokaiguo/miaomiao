...
<!--              <img src="../../../static/images/movie_1.jpg" height="179" width="128"/>-->
...
<style scoped>
  ...
  .movie_menu .search_entry{ float:right;margin-right:20px; height:100%; line-height: 45px;width: 24px}
  .movie_menu .search_entry.active{ color: #ef4238; border-bottom: 2px #ef4238 solid;}
  .movie_menu .search_entry i{  font-size:24px!important; color:red;}
</style>
